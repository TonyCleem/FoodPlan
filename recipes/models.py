...
class Recipe(models.Model):
    ...
    diet_type = models.CharField(
        max_length=20, choices=DIET_CHOICES, default="regular", verbose_name="Тип диеты"
    )
    dish_type = models.CharField(
        max_length=20, choices=TYPE_CHOICES, verbose_name="Тип блюда"
    )
    no_gluten = models.BooleanField(default=False, verbose_name="Без глютена")

    high_protein = models.BooleanField(default=False, verbose_name="Высокобелковое")
...
class UserProfile(models.Model):
    ...
    liked_recipes = models.ManyToManyField(
        Recipe, related_name="liked_by", blank=True, verbose_name="Лайкнутые рецепты"
    )
