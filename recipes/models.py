...
class Ingredient(models.Model):
    ...
    allergens = models.CharField(
        ...
        help_text='Через запятую: арахис, молоко, яйца'
    )
...
class Recipe(models.Model):
    ...
    diet_type = models.CharField(max_length=20, choices=DIET_CHOICES, default='regular', verbose_name='Тип диеты')
    dish_type = models.CharField(max_length=20, choices=TYPE_CHOICES, verbose_name='Тип блюда')
    no_gluten = models.BooleanField(default=False, verbose_name='Без глютена')
    created_at = models.DateTimeField(auto_now_add=True, verbose_name='Дата создания')
    meal_type = models.CharField(max_length=20, choices=MEAL_TYPE_CHOICES, default='lunch', verbose_name='Тип приема пищи')
    instructions = models.TextField(verbose_name='Инструкция приготовления', blank=True)
...
class UserProfile(models.Model):
    ...
    disliked_recipes = models.ManyToManyField(Recipe, related_name='disliked_by', blank=True, verbose_name='Дизлайкнутые рецепты')
